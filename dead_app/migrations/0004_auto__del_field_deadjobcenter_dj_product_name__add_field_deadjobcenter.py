...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeadJobCenter.dj_product_name'
        db.delete_column(u'dead_app_deadjobcenter', 'dj_product_name')

        # Adding field 'DeadJobCenter.dj_user_name'
        db.add_column(u'dead_app_deadjobcenter', 'dj_user_name',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DeadJobCenter.dj_product_name'
        db.add_column(u'dead_app_deadjobcenter', 'dj_product_name',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DeadJobCenter.dj_user_name'
        db.delete_column(u'dead_app_deadjobcenter', 'dj_user_name')
    ...
    models = {
        u'dead_app.deadjobcenter': {
            ...
            'dj_user_name': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'})
        },
